...
class CartSearchFilter extends Component {
    ...
    //     return (
    //         <div>
    //             <div className="CartSearchFilter row">
    //                 <div id="SearchCol" className="CartSearchFilter-SearchCol col">
    //                     <Form>
    ...
    //                     </Form>
    //                 </div>
    //                 <div id="CreditsCol" className="CartSearchFilter-CreditsCol col">
    //                     <Form>
    ...
    //                     </Form>
    //                 </div>
    //                 <div id="SubjectsCol" className="CartSearchFilter-SubjectsCol col">
    //                     <Form>
...
export default CartSearchFilter;